    ...
    $('.entitylist').on("loaded", function() {
      ...
      var pageURL = window.location.href;
        ...
        $(this).children(".view-grid").find("tr[data-id]").each(function(i, e) {
          ...
          //$(this).append('<td class="el-buttons"><a href ="/edit-course?id=' + id + '" title="Edit Course"><img class="el-icon" id="el-edit-icon" src="/EditIcon.png" alt="Edit ' + label + ' course"/></a></td><td class="el-buttons"><a href ="/duplicate-course?id=' + id + '" title="Duplicate Course" ><img class="el-icon" src="/DuplicateIcon.png" alt="Duplicate ' + label + ' course"/></a></td>');
          $(this).append('<td class="el-buttons"><a href ="/admin-home/edit-course?id=' + id + '" title="Edit Course"><img class="el-icon" id="el-edit-icon" src="/EditIcon.png" alt="Edit ' + label + ' course"/></a></td><td class="el-buttons"><a href ="/admin-home/duplicate-course?id=' + id + '" title="Duplicate Course" ><img class="el-icon" src="/DuplicateIcon.png" alt="Duplicate ' + label + ' course"/></a></td>');
        });
      ...
      $(".col-lg-3.filter-vertical");
        ...
        $('<div class="card-header">Filters</div>').insertBefore('.card-body');
