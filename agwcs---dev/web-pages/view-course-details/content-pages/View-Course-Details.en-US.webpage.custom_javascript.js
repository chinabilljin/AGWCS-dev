...
$(document).ready(function(){
    ...
    webapi.safeAjax({
        ...
        error: function(xhr, status, error){
            ...
            console.log("LOAD IMAGE ERROR --- "+errorMessage);
        }
    });
    ...
    */
    ...
    {% if user %}
    // remove 4/7/2025 let's allow any role to Register a course
    ...
    $("#registerBtn").on("click", function(e){
        ...
        if (selectedAttendees.length > 0){
            ...
            "msdynce_coursename, cr635_programfee",
            contentType: "application/json",
            success: function (res) {
                ...
                var courseFee = res.cr635_programfee;
                ...
                if (selectedAttendees.length <= spots){
                    ...
                    selectedAttendees.forEach(function(element, index, array){
                        createRegistrationRecord(element, courseId , array.length, regParticipants, maxCapacity, startDate, endDate, courseTitle, courseFee);
                    });
                    } else {
    ...
    function createRegistrationRecord(attendee, courseId, length, participants, capacity, startDate, endDate, courseTitle, courseFee){
